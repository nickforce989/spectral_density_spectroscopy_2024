...
with open("metadata/MIX_GEVP_meta_F.csv", newline="") as csvfile:
        ...
        for i in range(len(CHs)):
            ...
            tmp_bin.append(
                read_hdf.get_meson_Cmat_mix(
                    DATA, ens_tag[row.get("ENS")], "fund", 0, 80, 40, ch[0], ch[1]
                )
            )
...
with open("../tables/F_meson_GEVP_mix.csv", "w", newline="") as csvfile:
