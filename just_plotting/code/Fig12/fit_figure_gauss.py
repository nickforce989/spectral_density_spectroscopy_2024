...
mean1, amplitude1, err_amplitude1 = 0.4098, 1.41e-6, 2.2e-7 
mean2, amplitude2, err_amplitude2 = 0.839, 6.8e-6, 1.e-6
...
data_points = np.loadtxt("../../../input_fit/Fig12/sp_dens_datapoints_gauss.txt")
...
plt.savefig(
            '../../../plots/fit_PAUL_gi_fund_N0_N0_double_2.pdf',
