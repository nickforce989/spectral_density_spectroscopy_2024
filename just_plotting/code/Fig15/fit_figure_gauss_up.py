...
mean1, amplitude1, err_amplitude1 = 0.4098, 4.69e-7, 3.e-8 
mean2, amplitude2, err_amplitude2 = 0.67, 4.7e-7, 6.3e-8
...
data_points = np.loadtxt("../../../input_fit/Fig15/sp_dens_datapoints_gauss_up.txt")
