...
output_file = '../../../plots/final_spectrum_PS.pdf'
...
for i in range(1):
    if i < 6:
        ...
        color = viridis_colors[i-6]
    ax.add_patch(plt.Rectangle((i - 0.7 + spacing*i +0.2, values_ground4[i] - errors_ground4[i]), 0.15, 2*errors_ground4[i], color=adjust_saturation(color, 10.2), alpha=0.7, hatch=hatches[1],fill=False))
...
for i in range(1):
    if i < 6:
        ...
        color = viridis_colors[i-6]
    ax.add_patch(plt.Rectangle((i - 0.7 + spacing*i +0.2, values_first4[i] - errors_first4[i]), 0.15, 2*errors_first4[i], color=adjust_saturation(color, 10.2), alpha=0.7, hatch=hatches[1],fill=False))
...
for i in range(1):
    if i < 6:
        ...
        color = viridis_colors[i-6]
    ax.add_patch(plt.Rectangle((i - 0.7 + spacing*i +0.2, values_second4[i] - errors_second4[i]), 0.15, 2*errors_second4[i], color=adjust_saturation(color, 10.2), alpha=0.7, hatch=hatches[1],fill=False))
...
for i in range(1):
    if i < 6:
        ...
        color = viridis_colors[i-6]
    ax.add_patch(plt.Rectangle((i + 0.15 + spacing*i+0.2, values_ground5[i] - errors_ground5[i]), 0.15, 2*errors_ground5[i], color=adjust_saturation(color, 10.2), alpha=0.7, hatch=hatches[0],fill=False))
...
for i in range(1):
    if i < 6:
        ...
        color = viridis_colors[i-6]
    ax.add_patch(plt.Rectangle((i + 0.15 + spacing*i+0.2, values_first5[i] - errors_first5[i]), 0.15, 2*errors_first5[i], color=adjust_saturation(color, 10.2), alpha=0.7, hatch=hatches[0],fill=False))
...
for i in range(1):
    if i < 6:
        ...
        color = viridis_colors[i-6]
    ax.add_patch(plt.Rectangle((i + 0.15 + spacing*i+0.2, values_second5[i] - errors_second5[i]), 0.15, 2*errors_second5[i], color=adjust_saturation(color, 10.2), alpha=0.7, hatch=hatches[0],fill=False))
...
ax.set_xticks([0])  # Set the tick at the center (position 0)
ax.set_xticklabels(['PS'], ha='center', fontsize=16),  # Set the tick label as 'PS' and align it to the center
...
legend_handles = [
    mpatches.Patch(color=viridis_colors[0], alpha=0.4),
    mpatches.Patch(color=viridis_colors[0], alpha=0.6),
    mpatches.Patch(color=viridis_colors[0], alpha=0.85),
    mpatches.Patch(color=viridis_colors[0], alpha=0.7,fill=False),
    mpatches.Patch(color=viridis_colors[0], alpha=0.7,fill=False),
]
