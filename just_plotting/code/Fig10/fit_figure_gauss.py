...
mean1, amplitude1, err_amplitude1 = 0.4098, 2.89e-7, 3.00e-8
mean2, amplitude2, err_amplitude2 = 0.700, 3.33e-7, 4.30e-8
...
data_points = np.loadtxt("../../../input_fit/Fig10/sp_dens_datapoints_gauss.txt")
...
plt.savefig(
            '../../../plots/fit_PAUL_gi_fund_N80_N40_double_2.pdf',
