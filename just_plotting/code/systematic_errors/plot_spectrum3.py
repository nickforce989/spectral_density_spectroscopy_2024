...
file_path = '../../../input_fit/systematic_errors/spectrum_first_fund.txt'
...
axs[0].set_ylim((0.605,0.725))
axs[1].set_ylim((0.655,0.895))
...
plt.savefig('../../../plots/nt64_spectrum_first_fund.pdf', dpi=300, bbox_inches='tight')
