...
file_path = '../../../input_fit/systematic_errors/spectrum_first_as.txt'
...
for i in range(3, 6):
    ...
    # Add shading between data points
    axs[1].fill_betweenx([0, 1.5], x[i] + 1.2*offset_gauss_k, x[i] + 1.2*offset_gauss_k1, color='gray', alpha=0.2)
...
plt.savefig('../../../plots/nt64_spectrum_first_as.pdf', dpi=300, bbox_inches='tight')
