...
mean1, amplitude1, err_amplitude1 = 0.4098, 8.13e-13, 3.2e-14 
mean2, amplitude2, err_amplitude2 = 0.700, 1.03e-12, 1.2e-13
...
data_points = np.loadtxt("../../../input_fit/Fig13/sp_dens_datapoints_gauss.txt")
