...
mean1, amplitude1, err_amplitude1 = 0.4098, 1.e-6, 0.05e-6 
mean2, amplitude2, err_amplitude2 = 0.7, 2.28e-6, 5.4e-7
...
data_points = np.loadtxt("../../../input_fit/Fig11/sp_dens_datapoints_gauss_up.txt")
