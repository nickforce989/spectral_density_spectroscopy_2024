...
mean1, amplitude1, err_amplitude1 = 0.4098, 1.8e-8, 2.6e-9 
mean2, amplitude2, err_amplitude2 = 0.7, 1.13e-8, 2.8e-9
...
data_points = np.loadtxt("../../../input_fit/Fig11/sp_dens_datapoints_gauss_down.txt")
...
plt.savefig(
            '../../../plots/fit_PAUL_gi_fund_N170_N170_double_2.pdf',
